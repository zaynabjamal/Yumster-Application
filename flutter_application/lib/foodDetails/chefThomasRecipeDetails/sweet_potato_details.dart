...
class SweetPotato extends StatefulWidget {
  const SweetPotato({super.key});

  @override
  State<SweetPotato> createState() => _FoodRecipeState();
}

class _FoodRecipeState extends State<SweetPotato> {
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: const DecorationImage(
                    image: AssetImage('assets/thomasrecipe3.webp'),
                    opacity: 0.5,
                    fit: BoxFit.fill,
                  ),
                  boxShadow: [
            ...
            Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: const Column(
                    children: [
                      DotList(text: '4 lb. sweet potatoes'),
                      DotList(text: '4 tbsp. unsalted butter'),
                      DotList(text: '3 tbsp. packed brown sugar'),
                      DotList(text: '2 tbsp. honey'),
                      DotList(text: '1⁄2 tsp. ground allspice'),
                      DotList(text: 'Kosher salt'),
                      DotList(text: '6 oz. mascarpone cheese, softened'),
                      DotList(text: '3 cups mini marshmallows'),
                    ],
                  ),
                ),
                Container(
