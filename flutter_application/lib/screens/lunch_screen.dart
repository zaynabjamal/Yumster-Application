...
import 'package:flutter_application/data/lunch_food_data.dart';
...
class Lunch extends StatefulWidget {
  ...
  @override
  State<Lunch> createState() => _OthersState();
}

class _OthersState extends State<Lunch> {
  late List<FoodTypeModel> shuffledFoodTypeData;
  @override
  void initState() {
    super.initState();
    shuffledFoodTypeData = List.from(lunchData);
